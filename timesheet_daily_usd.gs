...
/*function lookupConsultantRates(consultantName) {
  try {
    ...
    console.log('Column indices:', {
      nameColIndex, emailIndex, contractorRateIndex,
      clientRateIndex, partnerIndex, clientCounterpartsIndex, execAssistantIndex
    });
    ...
    const addVat = vatStatusIndex !== -1 &&
    consultantRow[vatStatusIndex]?.toString().toLowerCase().trim() === 'yes';
